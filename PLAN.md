...
|---|---|---|---|---|---|
| [FastEmbed 6 and ORT rc13 cache](docs/plans/2026-09-08-fastembed-6-ort-cache.md) | Build a provenance-complete, fail-closed artifact cache for `the-one-mcp` FastEmbed 6.0.2 and `ort-sys` 2.0.0-rc.13. | source checkpoint complete at `checkpoint/6.0.3`; publication blocked | 2026-09-08 | 2026-09-08 | 2026-09-10 |
